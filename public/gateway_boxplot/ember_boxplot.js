(function () {
  const bugDataRaw = {
    E01: [11877, 30187], 
    FW12: [9186, 20998, 7638, 10626, 51747, 47296, 29330, 6199, 7695, 9915],
    FW23: [28462, 57558, 23091, 81835, 9747],
    GATFP01: [13, 23, 21, 14, 68, 18, 18, 15, 214, 154],
    GATFP02: [11191, 30959],
    GATFP03: [],
    GATFP04: [11192, 30959],
    GATFP05: [],
  ...
  document.addEventListener('DOMContentLoaded', function () {
    renderBoxPlot('ember_gateway_boxplot');
  });
})();
